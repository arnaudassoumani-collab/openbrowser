/******/ (() => {
  ...
  \*******************************/
      /***/ (
        ...
        /* harmony import */ var _settings_migrations__WEBPACK_IMPORTED_MODULE_16__ =
          __webpack_require__(
            /*! ./settings.migrations */ "./src/options/settings.migrations.ts"
          );
          ...
          (0, react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
            ...
            const loadSavedConfig = async () => {
              ...
              if (!configLoaded) {
                ...
                const migratedLlmConfig = (0,
                _settings_migrations__WEBPACK_IMPORTED_MODULE_16__.migrateLLMConfig)(
                  result.llmConfig
                );
                const migratedHistoryConfig = (0,
                _settings_migrations__WEBPACK_IMPORTED_MODULE_16__.migrateHistoryLLMConfig)(
                  result.historyLLMConfig
                );
                const llmConfigRaw = migratedLlmConfig.value;
                const historyConfigRaw = migratedHistoryConfig.value;
                if (
                  migratedLlmConfig.changed ||
                  migratedHistoryConfig.changed
                ) {
                  await chrome.storage.local.set({
                ...
                if (llmConfigRaw) {
                  const nextConfig = {
                    ...llmConfigRaw,
                    schemaVersion:
                      _settings_migrations__WEBPACK_IMPORTED_MODULE_16__.SETTINGS_SCHEMA_VERSION,
                    authMode: normalizeAuthMode(
                      llmConfigRaw === null || llmConfigRaw === void 0
                        ? void 0
                        : llmConfigRaw.authMode
                    ),
                    oauthClientId: String(
                      (llmConfigRaw === null || llmConfigRaw === void 0
                        ? void 0
                        : llmConfigRaw.oauthClientId) || ""
                    ).trim(),
                    oauthScopes: String(
                      (llmConfigRaw === null || llmConfigRaw === void 0
                        ? void 0
                        : llmConfigRaw.oauthScopes) ||
                  ...
                  if (
                    ...
                    !((_b = modelOptions[nextConfig.llm]) === null ||
                    _b === void 0
                      ? void 0
                      : _b.some((m) => m.value === nextConfig.modelName))
                  ) {
                    nextConfig.modelName =
                      ((_d =
                        (_c = modelOptions[nextConfig.llm]) === null ||
                        _c === void 0
                          ? void 0
                          : _c[0]) === null || _d === void 0
                        ? void 0
                  ...
                  if (
                    !((_e = nextConfig.options) === null || _e === void 0
                      ? void 0
                      : _e.baseURL)
                  ) {
                    nextConfig.options = {
                      ...
                      _llm_llm__WEBPACK_IMPORTED_MODULE_14__.getDefaultBaseURL)(
                        nextConfig.llm,
                        (_f = providersData[nextConfig.llm]) === null ||
                          _f === void 0
                          ? void 0
                          : _f.api
                      )
                  ...
                  if (isBridgeRoutedProvider) {
                    ...
                    if (
                      ...
                      !isLocalBaseURL(
                        String(
                          ((_g = nextConfig.options) === null || _g === void 0
                            ? void 0
                            : _g.baseURL) || ""
                        )
                      )
                  ...
                  nextConfig.apiKey = "";
                  const configValidation = (0,
                  _settings_migrations__WEBPACK_IMPORTED_MODULE_16__.validateLLMConfig)(
                    nextConfig
                  );
                        ...
                        setGoogleOAuthStatus({
                          connected: Boolean(
                            (_h =
                              oauthStatus === null || oauthStatus === void 0
                                ? void 0
                                : oauthStatus.data) === null || _h === void 0
                              ? void 0
                              : _h.connected
                          ),
                          expiresAt: Number(
                            ((_j =
                              oauthStatus === null || oauthStatus === void 0
                                ? void 0
                                : oauthStatus.data) === null || _j === void 0
                              ? void 0
                              : _j.expiresAt) || 0
                          ),
                          issuedAt: Number(
                            ((_k =
                              oauthStatus === null || oauthStatus === void 0
                                ? void 0
                                : oauthStatus.data) === null || _k === void 0
                              ? void 0
                              : _k.issuedAt) || 0
                          ),
                          scope:
                            String(
                              ((_l =
                                oauthStatus === null || oauthStatus === void 0
                                  ? void 0
                                  : oauthStatus.data) === null || _l === void 0
                                ? void 0
                                : _l.scope) || ""
              ...
              if (
                config.modelName &&
                !((_m = modelOptions[config.llm]) === null || _m === void 0
                  ? void 0
                  : _m.some((m) => m.value === config.modelName))
              ) {
                const nextModel =
                  ((_p =
                    (_o = modelOptions[config.llm]) === null || _o === void 0
                      ? void 0
                      : _o[0]) === null || _p === void 0
                    ? void 0
                    : _p.value) || "";
                  ...
                  const previousBridgeBaseURL = String(
                    ((_c =
                      loadedBridgeCfg === null || loadedBridgeCfg === void 0
                        ? void 0
                        : loadedBridgeCfg[configStorageKey]) === null ||
                    _c === void 0
                      ? void 0
                      : _c.bridgeBaseURL) || defaultFallbackURL
                  ).trim();
  ...
  \********************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ SETTINGS_SCHEMA_VERSION: () =>
            /* binding */ SETTINGS_SCHEMA_VERSION,
          /* harmony export */ migrateHistoryLLMConfig: () =>
            /* binding */ migrateHistoryLLMConfig,
          /* harmony export */ migrateLLMConfig: () =>
            /* binding */ migrateLLMConfig,
          /* harmony export */ validateLLMConfig: () =>
            /* binding */ validateLLMConfig
          /* harmony export */
        });
        ...
        function sanitizeLLMConfig(raw) {
          ...
          out.oauthScopes = String(
            out.oauthScopes || GOOGLE_OAUTH_DEFAULT_SCOPE
          )
            .trim()
            .replace(/\s+/g, " ");
